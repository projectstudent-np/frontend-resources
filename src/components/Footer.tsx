            ...
            <div className="footer-container">
                <div className="footer-row">
                    <div className="footer-brand">
                        <div className="footer-logo">
                            ...
                            <span className="footer-logo-text">Nova Ponte, MG</span>
                        </div>
                        <p className="footer-brand-desc">
                            Sistema oficial de carteirinhas estudantis do município de Nova Ponte, MG.
                        </p>
                    </div>

                    <div className="footer-right">
                        <div className="footer-columns-header">
                            <Link to="/access?tab=register" className="btn btn-sm footer-cta">
                        ...
                        <div className="footer-columns">
                            ...
                            <div className="footer-col">
                                <h4 className="footer-col-title">Propriedades</h4>
                                <ul className="footer-col-list">
                            ...
                            <div className="footer-col">
                                <h4 className="footer-col-title">Transparência</h4>
                                <ul className="footer-col-list">
                                    <li><Link to="/key-users">Usuários chave</Link></li>
                                    <li><Link to="/transparency">Transparência do projeto</Link></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div className="footer-bottom">
                    <p className="footer-copyright">
                        &copy; {new Date().getFullYear()} Prefeitura Municipal de Nova Ponte. Todos os direitos reservados.
                    </p>
                    <a
                        href={REPO_URL}
                        target="_blank"
