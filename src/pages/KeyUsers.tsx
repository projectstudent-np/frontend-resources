...
const TEAM: TeamMember[] = [
    ...
    {
        name: 'Danilo',
        role: 'Analista e Estatística',
        description:
            'Responsável pela análise de dados e estatísticas do sistema, além de verificar a usabilidade da plataforma para garantir a melhor experiência aos usuários.',
        image: null,
    },
];
            ...
            <div className="key-users-content">
                <section className="key-users-section">
                    ...
                    <p className="key-users-section-text">
                        O sistema de carteirinhas é um projeto desenvolvido por estudantes para a gestão digital
                        e utilização dos alunos em prol do Município de Nova Ponte. A plataforma
                        moderniza o processo de solicitação, emissão e validação de carteirinhas
                        estudantis para o transporte público escolar, conectando estudantes,
                        motoristas, executivos e administradores em um fluxo digital completo
                        — da solicitação à validação no ônibus.
                    </p>
                </section>
                ...
                <section className="key-users-section">
                    ...
                    <p className="key-users-section-desc">
                        O projeto é conduzido por três usuários chave, cada um com um papel essencial
                        para o funcionamento e evolução da plataforma.
                    </p>
                        ...
                        {TEAM.map((member) => (
                            <div key={member.name} className="key-users-card card">
                                <div className="key-users-card-top">
                                    ...
                                    <button type="button" className="key-users-linkedin" aria-label="LinkedIn">
