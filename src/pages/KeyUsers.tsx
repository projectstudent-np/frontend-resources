...
const TEAM: TeamMember[] = [
  ...
  },
  {
    ...
    image: "/logo-pedrouser.png",
    linkedin: "https://www.linkedin.com/in/initpedro",
  },
]
      ...
      <div className="key-users-content">
        ...
        <section className="key-users-section">
          ...
          <div className="key-users-grid">
            {TEAM.map((member) => (
              <div key={member.name} className="key-users-card">
                <div className="key-users-photo-wrap">
                  {member.image ? (
                    <img
                      src={member.image}
                      alt={member.name}
                      className="key-users-photo"
                    />
                  ) : (
                    <div className="key-users-photo-placeholder">
                      <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
                        <circle cx="32" cy="32" r="32" fill="#F2F4F7" />
                        <circle cx="32" cy="25" r="10" fill="#98A2B3" />
                        <path d="M14 56c0-10 8-18 18-18s18 8 18 18" stroke="#98A2B3" strokeWidth="2.5" fill="none" />
                      </svg>
                    </div>
                  )}
                </div>
